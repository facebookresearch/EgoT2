...
import torch
from tasks.lta.long_term_anticipation import MultiTaskClassificationTask, LongTermAnticipationTask, LongTermAnticipationTaskSeq, LongTermAnticipationTaskSeparateSeq
from tasks.lta.long_term_anticipation_taskspecfic import RecognitionTask2Loader, LTA2Loader
from utils.lta.c2_model_loading import get_name_convert_func
from utils.lta.misc import gpu_mem_usage
from utils.lta.parser import load_config, parse_args
...
def main(cfg):
    ...
    elif cfg.DATA.TASK == "classification2loader":
        TaskType = RecognitionTask2Loader
    elif cfg.DATA.TASK == "long_term_anticipation":
        TaskType = LongTermAnticipationTask
    elif cfg.DATA.TASK == "long_term_anticipation_seq":
        TaskType = LongTermAnticipationTaskSeq
    elif cfg.DATA.TASK == "long_term_anticipation_separateseq":
        TaskType = LongTermAnticipationTaskSeparateSeq
    elif cfg.DATA.TASK == "lta2loader":
        TaskType = LTA2Loader
    ...
    if cfg.TRAIN.ENABLE and cfg.TEST.ENABLE:
        ...
        trainer.validate(task, ckpt_path=cfg.CHECKPOINT_FILE_PATH)
        return trainer.test(task, ckpt_path=cfg.CHECKPOINT_FILE_PATH)

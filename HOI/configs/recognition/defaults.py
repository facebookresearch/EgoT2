...
# Transformer depth.
_C.MODEL.TRANSLATION_LAYERS = 3

_C.MODEL.TRANSLATION_INPUT_FEATURES = 2048

_C.MODEL.TRANSLATION_HEADS = 8

_C.MODEL.TRANSLATION_DROPOUT = 0.1
...
_C.CHECKPOINT_FILE_PATH_AR = ""
_C.CHECKPOINT_FILE_PATH_LTA = ""
...
# -----------------------------------------------------------------------------
# Petrained model config
# -----------------------------------------------------------------------------
_C.PRETRAIN = CfgNode()

_C.PRETRAIN.PNR_CFG = None

_C.PRETRAIN.PNR_FT = True

_C.PRETRAIN.OSCC_CFG = None

_C.PRETRAIN.OSCC_FT = True

_C.PRETRAIN.ACTION_CFG = None

_C.PRETRAIN.ACTION_FT = True

_C.PRETRAIN.LTA_CFG = None
